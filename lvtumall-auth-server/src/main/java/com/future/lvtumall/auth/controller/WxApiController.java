package com.future.lvtumall.auth.controller;
...
import com.future.lvtumall.auth.utils.ConstantWxUtils;
import com.future.lvtumall.auth.utils.HttpClientUtils;
    ...
    public String callback(String code,String state, HttpSession session) throws Exception {
        ...
        try {
            ...
            if (r.getCode() == 0) {
                ...
                return "redirect:http://auth.lvtumall.com/login.html";
            }
