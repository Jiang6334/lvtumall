...
import com.future.lvtumall.coupon.service.MemberPriceService;
import com.future.lvtumall.coupon.service.SkuFullReductionService;
import com.future.lvtumall.coupon.service.SkuLadderService;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public void saveSkuReduction(SkuReductionTo skuReductionTo) {
        ...
        //1、保存满减打折、会员价
        //1、1）、sku的优惠、满减等信息：lvtumall_sms--->sms_sku_ladder、sms_sku_full_reduction、sms_member_price
