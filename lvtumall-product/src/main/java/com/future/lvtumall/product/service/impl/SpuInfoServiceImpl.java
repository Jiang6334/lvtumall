...
import com.future.common.to.SkuHasStockVo;
import com.future.common.to.SkuReductionTo;
import com.future.common.to.SpuBoundTo;
import com.future.common.utils.PageUtils;
import com.future.common.utils.Query;
import com.future.common.utils.R;
import com.future.lvtumall.product.dao.SpuInfoDao;
import com.future.lvtumall.product.entity.*;
import com.future.lvtumall.product.feign.CouponFeignService;
import com.future.lvtumall.product.feign.SearchFeignService;
...
//    @GlobalTransactional(rollbackFor = Exception.class)
    ...
    public void savesupInfo(SpuSaveVo vo) {
        ...
        //5、保存spu的积分信息：lvtumall_sms--->sms_spu_bounds
        ...
        if(skus!=null && skus.size()>0){
            skus.forEach(item->{
                ...
                //5、4）、sku的优惠、满减等信息：lvtumall_sms--->sms_sku_ladder、sms_sku_full_reduction、sms_member_price
...
//    @GlobalTransactional(rollbackFor = Exception.class)
    ...
    public void up(Long spuId) {
        ...
        //TODO 5、将数据发给es进行保存：lvtumall-search
